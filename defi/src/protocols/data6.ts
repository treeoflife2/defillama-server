...
    referralUrl: "https://mnstr.xyz?ref=DARKRAIGUYARCANE",
  ...
  {
    id: "7855",
    name: "EVplusAI Predictions",
    address: null,
    symbol: "-",
    url: "https://pm.evplus.ai/",
    description: "Polymarket Bot.",
    chain: "Polygon",
    logo: `${protocolIconsUrl}/evplusai-predictions`,
    audits: "0",
    gecko_id: null,
    cmcId: null,
    tags: ["Polymarket Builder"],
    ...
    module: "dummy.js",
    twitter: "EVplusAI",
    parentProtocol: "parent#evplusai",
    dimensions: {
      fees: "evplusai",
      dexs: "evplusai",
    },
...
    referralUrl: "https://app.propr.xyz/r/41PGwHGY",
  ...
  },
  {
    ...
    chain: "CookieChain",
    logo: `${protocolIconsUrl}/cookiebox`,
    audits: "0",
    gecko_id: null,
    cmcId: null,
    tags: ["AMM"],
  ...
  },
  {
    ...
    address: "solana:36ZrtQoab5MhhySaP1YSTwUahSk6GRVUTtZ6cuVfm9e1",
    symbol: "COOK",
  ...
  },
  {
    ...
    chain: "Arbitrum",
    logo: `${protocolIconsUrl}/afx-bridge`,
    audits: "2",
    gecko_id: null,
    cmcId: null,
    category: "Derivatives",
  ...
  },
  {
    ...
    description: "AFX is a high-performance sovereign L1 purpose-built for decentralized derivatives. By synthesizing the rapid execution of a centralized exchange with the immutable sovereignty of the blockchain, AFX delivers a professional-grade Perp DEX environment characterized by sub-100ms finality, institutional liquidity, and unmatched capital efficiency. AFX fees are generated from perpetual trading activity, excluding funding, with non-protocol allocations including referral rebates, trader rewards, Points Program rewards, and other incentive distributions. The Points Program rewards trading activity, AFX LP Vault participation, and Guild activity. See https://docs.afx.xyz and https://medium.com/@AFXTrade for more details.",
    chain: "AFX L1",
    logo: `${protocolIconsUrl}/afx-perps`,
    audits: "0",
    gecko_id: null,
    cmcId: null,
    category: "Derivatives",
  ...
  },
  {
    ...
    chain: "Starknet",
    logo: `${protocolIconsUrl}/extended-spot`,
    audits: "0",
    gecko_id: null,
    cmcId: null,
    tags: ["Order Book"],
    chains: ["Starknet"],
    module: "extended-spot-orderbook/index.js",
    twitter: "extendedapp",
  ...
  },
  {
    ...
    address: null,
    symbol: "-",
    url: " ", // pending to add url https://hypurrquant.com/
    description:
      "HypurrQuant is a non-custodial DeFi terminal and swap/LP aggregator on HyperEVM. It routes user swaps through underlying aggregators (LiquidSwap, HyperBloom, Relay, deBridge) and earns a 0.05% integrator fee paid into its fee-recipient wallet.",
    chain: "Hyperliquid L1",
    logo: `${protocolIconsUrl}/hypurrquant`,
    audits: "0",
    gecko_id: null,
    cmcId: null,
    category: "DEX Aggregator",
  ...
  },
  {
    ...
    symbol: "JUP",
    url: "https://offerbook.jup.ag",
    description: "Jupiter Offerbook is a permissionless, peer-to-peer money market for any onchain assets on Solana.",
    chain: "Solana",
    logo: `${protocolIconsUrl}/jupiter-offerbook`,
    audits: "0",
    gecko_id: null,
    cmcId: null,
    category: "Lending",
    chains: ["Solana"],
    module: "jupiter-offerbook/index.js",
  ...
  },
  {
    ...
    address: null,
    symbol: "-",
    url: "https://app.insightx.finance/",
    description: "InsightX is an AI-native InfoFi prediction market protocol that transforms real-world information, expectations and market signals into tradable, verifiable, and yield-generating on-chain assets.",
    chain: "Mantle",
    logo: `${protocolIconsUrl}/insightx`,
    audits: "0",
    gecko_id: null,
    cmcId: null,
    category: "Prediction Market",
  ...
  },
  {
    ...
    description: "USDCx is a private, programmable stablecoin on Aleo built with Circle, backed 1:1 by USDC held in Circle xReserve",
    chain: "Ethereum",
    logo: `${protocolIconsUrl}/usdcx`,
    audits: "0",
    gecko_id: null,
    cmcId: null,
    category: "Stablecoin Wrapper",
    chains: ["Ethereum"],
    module: "circle-xreserve/index.js",
    twitter: "circle",
    parentProtocol: "parent#circle",
    listedAt: 1782415477,
  },
  {
    ...
    address: null,
    symbol: "-",
    url: " ", // pending to add url https://boar.finance/
    description: "Boar Finance is a non-custodial staking platform built by Boar Network, crypto infrastructure operators since 2020. We automates strategies to optimize user earnings across multiple protocols and blockchains",
    chain: "Mezo",
    logo: `${protocolIconsUrl}/boar-finance`,
    audits: "0",
    gecko_id: null,
    cmcId: null,
    category: "Yield Aggregator",
    chains: ["Mezo"],
    module: "boar-finance/index.js",
    twitter: "BoarNetwork",
    listedAt: 1782415829,
  },
  {
    ...
    symbol: "-",
    url: "https://mmt.gg/",
    description: "MMT Perps allows users to trade perps on Hyperliquid L1.",
    chain: "Hyperliquid L1",
    logo: `${protocolIconsUrl}/mmt-perps`,
    audits: "0",
    gecko_id: null,
    cmcId: null,
    tags: ["Hyperliquid Builder"],
    chains: ["Hyperliquid L1"],
    module: "dummy.js",
    twitter: "MMT_Official_",
    dimensions: {
      fees: "mmt-perps",
      derivatives: "mmt-perps",
    }
  },
  {
    id: "8081",
    ...
    address: null,
    symbol: "-",
    url: " ", // pending to add url https://topdog.gg/ url unreachble
    description: "Topdog Perps allows users to trade perps on Hyperliquid L1.",
    chain: "Hyperliquid L1",
    logo: `${protocolIconsUrl}/topdog-perps`,
    audits: "0",
    gecko_id: null,
    cmcId: null,
    tags: ["Hyperliquid Builder"],
  ...
  },
  {
    ...
    address: null,
    symbol: "-",
    url: "https://www.invoapp.com/",
    description: "Invo Perps allows users to trade perps on Hyperliquid L1.",
    chain: "Hyperliquid L1",
    logo: `${protocolIconsUrl}/invo-perps`,
    audits: "0",
    gecko_id: null,
    cmcId: null,
    tags: ["Hyperliquid Builder"],
  ...
  },
  {
    ...
    description: "EVplusAI Perps allows users to trade perps on Hyperliquid L1.",
    chain: "Hyperliquid L1",
    logo: `${protocolIconsUrl}/evplusai-perps`,
    audits: "0",
    gecko_id: null,
    cmcId: null,
    tags: ["Hyperliquid Builder"],
  ...
  },
  {
    ...
    address: null,
    symbol: "-",
    url: "https://www.jester.trade/",
    description: "Jester Perps allows users to trade perps on Hyperliquid L1.",
    chain: "Hyperliquid L1",
    logo: `${protocolIconsUrl}/jester-perps`,
    audits: "0",
    gecko_id: null,
    cmcId: null,
    tags: ["Hyperliquid Builder"],
  ...
  },
  {
    ...
    description: "Vergex Perps allows users to trade perps on Hyperliquid L1.",
    chain: "Hyperliquid L1",
    logo: `${protocolIconsUrl}/vergex-perps`,
    audits: "0",
    gecko_id: null,
    cmcId: null,
    tags: ["Hyperliquid Builder"],
  ...
  },
  {
    ...
    address: null,
    symbol: "-",
    url: "https://app.cipher.gg/perpetuals",
    description: "Cipher Perps allows users to trade perps on Hyperliquid L1.",
    chain: "Hyperliquid L1",
    logo: `${protocolIconsUrl}/cipher-perps`,
    audits: "0",
    gecko_id: null,
    cmcId: null,
    tags: ["Hyperliquid Builder"],
    chains: ["Hyperliquid L1"],
    module: "dummy.js",
    twitter: "tradeonCipher",
    dimensions: {
      fees: "cipher-perps",
      derivatives: "cipher-perps",
    }
  },
  {
    id: "8087",
    ...
    description: "Cwallet Perps allows users to trade perps on Hyperliquid L1.",
    chain: "Hyperliquid L1",
    logo: `${protocolIconsUrl}/cwallet-perps`,
    audits: "0",
    gecko_id: null,
    cmcId: null,
    tags: ["Hyperliquid Builder"],
    ...
    dimensions: {
      fees: "cwallet-perps",
      derivatives: "cwallet-perps",
    }
  },
  {
    id: "8088",
    name: "Origami Tech Perps",
    address: null,
    symbol: "-",
    url: "https://origami.tech/",
    description: "Origami Tech Perps allows users to trade perps on Hyperliquid L1.",
    chain: "Hyperliquid L1",
    logo: `${protocolIconsUrl}/origami-tech-perps`,
    audits: "0",
    gecko_id: null,
    cmcId: null,
    tags: ["Hyperliquid Builder"],
    ...
    dimensions: {
      fees: "origami-tech-perps",
      derivatives: "origami-tech-perps",
    }
  },
  {
    id: "8089",
    name: "cro.trade Perps",
    address: null,
    symbol: "-",
    url: "https://cro.trade/profile",
    description: "cro.trade Perps allows users to trade perps on Hyperliquid L1.",
    chain: "Hyperliquid L1",
    logo: `${protocolIconsUrl}/cro.trade-perps`,
    audits: "0",
    gecko_id: null,
    cmcId: null,
    tags: ["Hyperliquid Builder"],
    ...
    twitter: "crotrade",
    dimensions: {
      fees: "cro-trade-perps",
      derivatives: "cro-trade-perps",
    }
  },
  {
    id: "8090",
    name: "Blockchain Wallet Perps",
    address: null,
    symbol: "-",
    url: "https://www.blockchain.com/perps",
    description: "Blockchain Wallet Perps allows users to trade perps on Hyperliquid L1.",
    chain: "Hyperliquid L1",
    logo: `${protocolIconsUrl}/blockchain-wallet-perps`,
    audits: "0",
    gecko_id: null,
    cmcId: null,
    tags: ["Hyperliquid Builder"],
    ...
    twitter: "blockchain",
    dimensions: {
      fees: "blockchain-wallet-perps",
      derivatives: "blockchain-wallet-perps",
    }
  },
  {
    id: "8091",
    ...
    address: null,
    symbol: "-",
    url: "https://app.onyx.live/trade",
    description: "Onyx Perps allows users to trade perps on Hyperliquid L1.",
    chain: "Hyperliquid L1",
    logo: `${protocolIconsUrl}/onyx-perps`,
    audits: "0",
    gecko_id: null,
    cmcId: null,
    tags: ["Hyperliquid Builder"],
    chains: ["Hyperliquid L1"],
    module: "dummy.js",
    twitter: "Onyx_terminal",
    dimensions: {
      fees: "onyx-perps",
      derivatives: "onyx-perps",
    }
  },
  {
    id: "8092",
    ...
    symbol: "-",
    url: "https://xbit.com/",
    description: "XBIT Perps allows users to trade perps on Hyperliquid L1.",
    chain: "Hyperliquid L1",
    logo: `${protocolIconsUrl}/xbit-perps`,
    audits: "0",
    gecko_id: null,
    cmcId: null,
    tags: ["Hyperliquid Builder"],
...
    referralUrl: "https://fomo.family/r/llamas",
    description: "fomo Perps allows users to trade perps on Hyperliquid L1.",
    chain: "Hyperliquid L1",
    ...
    module: "dummy.js",
    twitter: "fomo",
    parentProtocol: "parent#fomo",
    dimensions: {
      fees: "fomo-social-trading-perps",
      derivatives: "fomo-social-trading-perps",
    }
  },
  {
    id: "8094",
    ...
    description: "Atomic Perps allows users to trade perps on Hyperliquid L1.",
    chain: "Hyperliquid L1",
    logo: `${protocolIconsUrl}/atomic-perps`,
    audits: "0",
    gecko_id: null,
    cmcId: null,
    tags: ["Hyperliquid Builder"],
  ...
  },
  {
    ...
    description: "HyperX Perps allows users to trade perps on Hyperliquid L1.",
    chain: "Hyperliquid L1",
    logo: `${protocolIconsUrl}/hyperx-perps`,
    audits: "0",
    gecko_id: null,
    cmcId: null,
    tags: ["Hyperliquid Builder"],
    ...
    dimensions: {
      fees: "hyperx-perps",
      derivatives: "hyperx-perps",
    }
  },
  {
    id: "8096",
    name: "VibeLiquid Perps",
    address: null,
    symbol: "-",
    url: "https://vibeliquid.xyz/",
    description: "VibeLiquid Perps allows users to trade perps on Hyperliquid L1.",
    chain: "Hyperliquid L1",
    logo: `${protocolIconsUrl}/vibeliquid-perps`,
    audits: "0",
    gecko_id: null,
    cmcId: null,
    tags: ["Hyperliquid Builder"],
  ...
  },
  {
    ...
    address: null,
    symbol: "-",
    url: "https://app.tria.so/",
    description: "Tria Perps allows users to trade perps on Hyperliquid L1.",
    chain: "Hyperliquid L1",
    logo: `${protocolIconsUrl}/tria-perps`,
    audits: "0",
    gecko_id: null,
    cmcId: null,
    tags: ["Hyperliquid Builder"],
  ...
  },
  {
    ...
    description: "Defi App Perps allows users to trade perps on Hyperliquid L1.",
    chain: "Hyperliquid L1",
    logo: `${protocolIconsUrl}/defi-app-perps`,
    audits: "0",
    gecko_id: null,
    cmcId: null,
    tags: ["Hyperliquid Builder"],
  ...
  {
    id: "8100",
    name: "Perpetual Bitcoin",
    address: "pulse:0xb47Fa3fdA09E61a68A8089E1f4d0F44bd993E6B9",
    symbol: "PB",
    url: " ", // pending to add url https://perpetualbitcoin.io/
    description: "Perpetual Bitcoin is an immutable fixed-supply BTC-style asset on PulseChain that uses a price-triggered DCA-out vault to automatically realize profits into USDL as price milestones are reached.",
    chain: "Pulse",
    logo: `${protocolIconsUrl}/perpetual-bitcoin`,
    audits: "0",
    gecko_id: "perpetual-bitcoin",
    cmcId: null,
    category: "DCA Tools",
    chains: ["Pulse"],
    module: "perpetual-bitcoin/index.js",
    twitter: "PerpetualB67383",
    listedAt: 1782517721,
  },
  {
    id: "8101",
    ...
    description: "Suigar, a provably-fair on-chain casino on Sui mainnet, and its bankroll protocol SweetHouse.",
    chain: "Sui",
    logo: `${protocolIconsUrl}/suigar`,
    audits: "2",
    gecko_id: null,
    cmcId: null,
    category: "Luck Games",
    chains: ["Sui"],
    module: "suigar/index.js",
    twitter: "Suigar_com",
    audit_links: ["https://movebit.xyz/reports/Suigar-Audit-Report-2025-11-10.pdf"],
    listedAt: 1782518153,
  },
  {
    id: "8102",
    ...
    address: null,
    symbol: "-",
    url: "https://outcome.xyz/",
    description: "Prediction Markets on Hyperliquid, Trade outcomes on crypto, economics, sports, world-cup & more",
    chain: "Hyperliquid L1",
    logo: `${protocolIconsUrl}/outcome.xyz`,
    audits: "0",
    gecko_id: null,
    cmcId: null,
    tags: ["Hyperliquid Builder"],
  ...
  },
  {
    ...
    address: null,
    symbol: "-",
    url: " ", // pending to add url https://aurevaz.com/
    description: "Aurevaz is a token & LP locker on Polygon, Arbitrum and BSC.",
    chain: "Polygon",
    logo: `${protocolIconsUrl}/aurevaz`,
    audits: "0",
    gecko_id: null,
    cmcId: null,
    category: "Token Locker",
    chains: ["Polygon", "Arbitrum", "Binance"],
    module: "aurevaz/index.js",
    twitter: "aurevazcl",
    listedAt: 1782519093,
  },
  {
    ...
    description: "SafePal Card lets users spend from Fiat24 card accounts on Arbitrum.",
    chain: "Arbitrum",
    logo: `${protocolIconsUrl}/safepal-card`,
    audits: "0",
    gecko_id: null,
    cmcId: null,
    category: "Crypto Card Issuer",
  ...
  },
  {
    ...
    description: "Circle Gateway enables a unified USDC balance, unlocking on-demand liquidity and redefining crosschain UX",
    chain: "Ethereum",
    logo: `${protocolIconsUrl}/circle-gateway`,
    audits: "0",
    gecko_id: null,
    cmcId: null,
    category: "Cross Chain Bridge",
  ...
  },
  {
    ...
    address: null,
    symbol: "-",
    url: "https://swap.deepsea.monster/swap",
    description:
      "RocketSwap is a Uniswap V2 fork DEX deployed on Anubis.",
    chain: "Anubis",
    logo: `${protocolIconsUrl}/rocketswap-anubis`,
    audits: "0",
    gecko_id: null,
    cmcId: null,
    tags: ["AMM"],
    chains: ["Anubis"],
    module: "rocketswap-anubis/index.js",
    forkedFromIds: ["2197"],
  ...
  },
  {
    ...
    address: null,
    symbol: "-",
    url: " ", // pending to add url https://zodial.xyz/
    description:
      "Zodial is a portfolio-margin lending protocol that lets users earn yield, hedge, loop assets, and freely build their portfolio with maximal capital efficiency.",
    chain: "Solana",
    logo: `${protocolIconsUrl}/zodial`,
    audits: "2",
    gecko_id: null,
    cmcId: null,
    category: "Lending",
    chains: ["Solana"],
    module: "zodial/index.js",
    audit_links: ["https://s3.zodial.xyz/docs/2026_06_12_ackee-v1.1.pdf"],
    twitter: "zodial_xyz",
    forkedFromIds: ["2570"],
    listedAt: 1782859567,
  },
  {
    id: "8116",
    name: "AEON Protocol",
    address: "avax:0xd4c93eD1843606f92CccA078941f3d52A585982f",
    symbol: "AEON",
    url: " ", // pending to add url https://www.aeonprotocol.net/
    description:
      "AEON Protocol is a ve(3,3) DEX on Avalanche C-Chain (chainId 43114) with a unified factory that manages all pool types (vAMM, CL, DLMM).",
    chain: "Avalanche",
    logo: `${protocolIconsUrl}/aeon-protocol`,
    audits: "0",
    gecko_id: null,
    cmcId: null,
    tags: ["ve(3,3)"],
    chains: ["Avalanche"],
    module: "aeon-protocol/index.js",
    twitter: null,
    forkedFromIds: ["1407"],
    listedAt: 1782860371,
  },
