...
const ALLOWLIST: Record<string, string> = {
  ...
  "1:0xc689f76f90fe1762fac55983ff25ae71033a84f7": "PT-sUSDat-27AUG2026 — our price matches Pendle's own PT market (within ~1%); Morpho oracle is a conservative Pendle linear-discount oracle marking below the live market (same benign pattern as PT-USD3). Our price is the accurate one. (2026-06-26: the sUSDat underlying repriced down to ~$0.74 in a real Saturn credit event — see sUSDat entry — both our PT and Pendle moved together, conclusion unchanged)",
  "1:0xd166337499e176bbc38a1fbd113ab144e5bd2df7": "sUSDat — Saturn mezzanine token in a REAL credit event (junior jrUSDat at ~$0.22, apxUSD also crashed); our price (~$0.745, conf 0.99) tracks the live CoinGecko saturn-susdat market (~$0.739, $6.1M vol, -11%/24h). Morpho oracle (~$0.789) ≈ Pendle's underlying mark (~$0.788), both lagging the active depeg; the senior USDat holds par ($0.9995) and srUSDat ~$1.01. Our live-market price is the accurate/freshest one",
  ...
  "1:0x92a6a01b07984de46c24e8eba248449beb8b1dcb": "PT-apxUSD-18JUN2026 — matured 18JUN2026; our price ($0.7336) matches Pendle's own PT market ($0.7224, +1.55% — the only ref that did NOT breach). apxUSD underlying has genuinely fallen to ~$0.716 (Curve/Pendle), so the matured PT redeems near there; Morpho ChainlinkOracleV2 ($0.785) lags high/conservative. Same benign pattern as PT-apxUSD-5NOV (now opposite direction since the underlying crashed) — our price is the accurate one. Keyed by collateral addr to cover both the /USDC and /apxUSD markets",
